    ...
    <ProjectStyled id="projects">
      ...
      <div className="projectContainer">
        <div className="textDiv">
          ...
          <div className="descriptionDiv">
            <p>
              DevCoach is a web application that helps developers practice
              interviews with experienced coaches. Includes sign up/ Login for
              both students or coaches, list of coaches, dashboard for scheduled
              appointments, and visualisation for feedbacks. Also includes video
              chat, chat and code editor.
            </p>
          </div>
          <div className="techDiv">
            <h4>React</h4>
        ...
        <div className="imgDiv">
          <img alt="dev-coach" src={devCoach} />
        </div>
      </div>
      {/* Third project */}
      <div className="projectContainer">
        <div className="textDiv">
          ...
          <div className="descriptionDiv">
            <p>
              Crpto Tracker is a website that fetches and displays current
              crypto ratings with the option of switching to dark mode. It makes
              use of custom hooks to persist data to local storage.
            </p>
          </div>
      ...
      <div className="projectContainer">
        <div className="textDiv">
          ...
          <div className="descriptionDiv">
            <p>
              Rick and Morty is a fan page that fetches the characters of Rick
              and Morty from an api and renders it.
            </p>
          </div>
