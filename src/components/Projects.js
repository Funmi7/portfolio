...
const projects = [
  ...
  },
  {
    ...
    description:
      "Crpto Tracker is a website that fetches and displays current crypto ratings with the option of switching to dark mode. It makes use of custom hooks to persist data to local storage.",
    languages: ["React", "CSS", "SCSS"],
    webLink: "https://dark-mode-6fsisxspi.now.sh/",
    githubLink: "https://github.com/Funmi7/dark-mode",
    image: crpytoTracker,
